...
```sh
    ...
    10  30    60  100
          ...
          40      90
                ...
                80
```
In order to keep the height of a BST tree shorter, self-balancing trees will be introduced in [COMP9024/Trees/SelfBalancingBST](../../Trees/SelfBalancingBST/README.md).
