...
static void ReleaseResources(AstStmtNodePtr decls, AstFuncDefNodePtr funcs) {
  ...
  // FIXME:  
  // Free the heap memory allocatd via malloc().
...
int main(int argc, char **argv) {
  ...
  EmitLabel("# **************************** Auto-Genereated by scc  ******************************#");
  EmitLabel("#                                                                                    #"); 
  EmitLabel("# 1. For better understanding of C, recursion, call stack, tree and linked list.     #"); 
  EmitLabel("#                                                                                    #"); 
  EmitLabel("# 2. No code optimization.                                                           #"); 
  EmitLabel("#                                                                                    #");
  EmitLabel("# 3. Three columns in the assembly file: assembly code, IR, and comments             #"); 
  EmitLabel("#                                                                                    #");  
  EmitLabel("#                                                           COMP9024 24T2            #");
  EmitLabel("# ***********************************************************************************#\n\n\n");    
