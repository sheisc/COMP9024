...
static void PrintHtmlTable(FILE *dotFile, 
    ...
    // shiftTable
    fprintf(dotFile, "<tr> \n");
    fprintf(dotFile, "<td width=\"30\" height=\"30\" bgcolor=\"gray\">shiftTable[]</td> \n");
    for (long i = 0; i < n; ) {
        if (i < startTxt) {
            fprintf(dotFile, "<td border=\"0\" width=\"30\" height=\"30\" bgcolor=\"white\"> </td> \n");
            i++;
    ...
    fprintf(dotFile, "<tr> \n");
    fprintf(dotFile, "<td width=\"30\" height=\"30\" bgcolor=\"gray\">index</td> \n");
    for (long i = 0; i < n; ) {
        if (i < startTxt) {
            fprintf(dotFile, "<td border=\"0\" width=\"30\" height=\"30\" bgcolor=\"white\"> </td> \n");
            i++;
    ...
    // longestBP
    fprintf(dotFile, "<tr> \n");
    fprintf(dotFile, "<td width=\"30\" height=\"30\" bgcolor=\"gray\">longestBP[]</td> \n");
    for (long i = 0; i < n; ) {
        if (i < startTxt) {
            fprintf(dotFile, "<td border=\"0\" width=\"30\" height=\"30\" bgcolor=\"white\"> </td> \n");
            i++;
